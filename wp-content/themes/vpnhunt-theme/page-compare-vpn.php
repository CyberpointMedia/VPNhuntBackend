                    ...
                    <div class="right_content_sec">
                        <div class="overflow-x-auto md:mb-14 mb-8 mt-6">
                            <table class="w-auto table ">
                                ...
                                <tbody>
                                    <!-- <tr>
                                        <td class="py-2 px-3 text-base text-left border">
                                            <div class="items-center justify-between flex">
                                                Overall Rating 
                                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" />
                                            </div>
                                        </td>
                                        <td class="py-2 px-3 text-base text-center border">
                                            <div class="flex items-center mb-3 justify-center">
                                                ...
                                                <div class="text-sm font-medium text-black">9.7<i class="text-xs ml-1 not-italic text-black">/10</i></div>
                                            </div>
                                        </td>
                                        <td class="py-2 px-3 text-base text-center border">
                                            <div class="flex items-center mb-3 justify-center">
                                    ...
                                    <!-- <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Expert Review<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>

                                        <td class="py-2 px-3 text-sm text-center border">
                                            <a href="javascript:void(0);" class="text-red-400 font-medium">ExpressVPN Review</a>
                                        </td>

                                        <td class="py-2 px-3 text-sm text-center border">
                                            <a href="javascript:void(0);" class="text-red-400 font-medium">CyberGhost Review</a>
                                        </td>
                                        
                                    </tr>

                                    <tr>
                                        <td class="py-2 px-3 text-base font-medium text-left border bg-gray-light-200">Pricing</td>

                                        <td class="py-2 px-3 text-base text-center border bg-gray-light-200">&nbsp;</td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Cheapest Price<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Pay Monthly Price<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>

                                        <td class="py-2 px-3 text-base text-center border">$12.95/mo</td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Free Trial<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>

                                        <td class="py-2 px-3 text-base text-center border">N/A</td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Money-Back Guarantee<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>

                                        <td class="py-2 px-3 text-base text-center border">30 days </td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Data Cap<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>

                                        <td class="py-2 px-3 text-base text-center border">Unlimited</td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base font-medium text-left border bg-gray-light-200">Security & Privacy</td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Loggin Policy<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>

                                        <td class="py-2 px-3 text-base text-center border">No Identifying Data</td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Data Leaks<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>

                                        <td class="py-2 px-3 text-base text-center border">No Leak</td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Encryption<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>

                                        <td class="py-2 px-3 text-base text-center border ">chacha20, AES-256</td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Jurisdiction<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>

                                        <td class="py-2 px-3 text-base text-center border">British Virgin Islands (Privacy Haven)</td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base font-medium text-left border bg-gray-light-200">Speed & Servers</td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Average Local Download Speed<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>

                                        <td class="py-2 px-3 text-base text-center border">97Mbps</td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Servers<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>

                                        <td class="py-2 px-3 text-base text-center border">3,000</td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">IP Addresses<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Countries<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base font-medium text-left border bg-gray-light-200">Streaming & P2P</td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">US Netflix<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Streaming Services
                                            Unblocked<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>

                                        <td class="py-2 px-3 text-base text-center border">
                                            All 4, Amazon Prime Video, Disney+, HBO Max, Hulu, ITV Hub, Netflix,
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Torrenting<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base font-medium text-left border bg-gray-light-200">Compatibility</td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Simultaneous
                                            Connections<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Native App Support<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>

                                        <td class="py-2 px-3 text-base text-center border">
                                            Microsoft Windows, macOS, iOS, Android, Linux, Router
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Compatible via Router<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>

                                        <td class="py-2 px-3 text-base text-center border">
                                            Apple TV, Amazon Fire TV, Android TV, Chromecasr, Nintendo, PlayStation, Roku, Smart TV, Xbox
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Smart DNS<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base font-medium text-left border bg-gray-light-200">Additional Info</td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Kill Switch<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Browser Extensions<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>
                                        ...
                                        <td class="py-2 px-3 text-base text-center border">&nbsp;</td>
                                    </tr>

                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Works in China<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-3 text-base text-left border"><div class="items-center justify-between flex">Support<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/question-mark.svg" class="inline-block" /></div></td>
