        ...
        <div class="container mx-auto">
            <div class="text-center md:text-left">
                ...
                <p class="text-lg font-normal">
                    Lorem ipsum dolor sit amet, consectm,,netur adipiscing elit. Phasellus scelerisque ante eros, in aliquet elit gravida non. Maecenas vestibulum turpis orci, nec placerat dolor vulputate quis. Phasellus pellentesque hendrerit tempor.
                </p>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 grid-cols-1 gap-3 mt-12">
                ...
                <div class="<?php echo $color; ?> rounded-lg px-5 pb-8 md:pt-12 pt-8 relative blogs-col">
                    <a href="javascript:void(0);" class="absolute right-3 top-3">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/read-more-icon-white.svg" alt="<?php the_permalink(); ?>" class="w-8 h-8"/>
                    </a>
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/blog1.png" alt="<?php the_permalink(); ?>" class="mx-auto w-40 h-32 mb-5"/>
            ...
            <div aria-label="Page navigation example" class="mt-14">
                ...
                <li>
                    <a href="javascript:void(0);" class="flex items-center justify-center px-3 h-8 w-8 leading-tight font-medium text-sm bg-red-400 text-white rounded-full hover:bg-red-400 hover:text-white duration-300 mx-1">1</a>
                </li>
                <li>
